...
export const mainNav: NavItem[] = [
  ...
  { label: "Math", href: "/math-practice" },
  { label: "Music", href: "/music-maker" },
  { label: "Coloring", href: "/coloring-book" },
  { label: "Tracing", href: "/tracing" },
  { label: "Words", href: "/word-builder" },
  { label: "Spelling", href: "/spelling-bee" },
  { label: "Opposites", href: "/opposites" },
  { label: "Clock", href: "/tell-time" },
  { label: "Challenge", href: "/daily-challenge" },
