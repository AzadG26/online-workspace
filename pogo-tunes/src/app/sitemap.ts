...
const routes: SitemapEntry[] = [
  ...
  { path: "/math-practice", freq: "weekly", priority: 0.7 },
  { path: "/music-maker", freq: "weekly", priority: 0.7 },
  { path: "/offline", freq: "monthly", priority: 0.3 },
  { path: "/opposites", freq: "weekly", priority: 0.7 },
  { path: "/phonics", freq: "weekly", priority: 0.8 },
  { path: "/privacy", freq: "yearly", priority: 0.3 },
  { path: "/progress", freq: "weekly", priority: 0.7 },
  ...
  { path: "/spelling-bee", freq: "weekly", priority: 0.8 },
  { path: "/tell-time", freq: "weekly", priority: 0.7 },
  { path: "/terms", freq: "yearly", priority: 0.3 },
  { path: "/tracing", freq: "weekly", priority: 0.8 },
